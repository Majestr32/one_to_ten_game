...
class GamesRepository implements IGamesRepository{
  ...
  List<GameInfo> getGamesList() {
    ...
    return [
      //make constants
      GameInfo(minRounds: 1, maxRounds: 6, idName: "1_to_10",  minPlayers: 4, maxPlayers: 8, minMinutesPlay: 15, maxMinutesPlay: 30, assetPath: 'assets/images/21_game.jpg', onClickRoutePath: '/1to10game'),

...
class PlayerDisplayBox extends HookWidget {
  ...
  const PlayerDisplayBox({required this.onChanged,required this.playerName, this.onMinusClicked, this.hasMinusButton = false,Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final _controller = useTextEditingController.call(text: playerName);
    return Container(
